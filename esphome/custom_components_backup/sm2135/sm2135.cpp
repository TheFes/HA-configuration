...
// Modified with address taken from this example: https://html.alldatasheet.com/html-pdf/1133367/LINKAGE/SM2135E/342/1/SM2135E.html

// I copied it from the second guy ^ but I got it from a forum somewhere and I can't credit him - if that's you: thanks and sorry!
// This is an improved version of the sm2135 driver for use with ESPHome, it works better with the new Mirabella Genio RGBW globes
// than the current version (less craziness from white balance adjustments). It's not perfect though.
...
static const uint8_t SM2135_CW        =  0xC5; // 0x80;  // CW channel (Chip default)
