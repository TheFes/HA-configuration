...
@media (max-width: 400px) {
  ...
  `}getMinMaxFromSeverity(e){let a=1/0,o=-1/0;return e&&Array.isArray(e)&&e.forEach(e=>{const i=e.from,t=e.to;let l,n;if("number"==typeof i)l=i;else if("string"==typeof i&&"min"!==i){const e=parseFloat(i);isNaN(e)?"min"===i&&(l=-1/0):l=e}else"min"===i&&(l=-1/0);if("number"==typeof t)n=t;else if("string"==typeof t&&"max"!==t){const e=parseFloat(t);isNaN(e)?"max"===t&&(n=1/0):n=e}else"max"===t&&(n=1/0);void 0===l||isNaN(l)||(a=Math.min(a,l)),void 0===n||isNaN(n)||(o=Math.max(o,n))}),{min:a===1/0?0:a,max:o===-1/0?100:o}}_computePercent(e,a){if(!e||"number"!=typeof a)return 0;const o=e.max-e.min;return o<=0?0:(a-e.min)/o*100}renderColorBarSegments(e,a,o=!0){const{min:i,max:t}=this.getMinMaxFromSeverity(e.severity||[]),l=t-i;if(!e.severity||!Array.isArray(e.severity)||l<=0)return K;const n=e.severity.filter(e=>"disabled"!==e.color&&null!==e.from&&null!==e.to&&void 0!==e.color);if(0===n.length)return K;const r=n.map((a,o)=>{const r=parseFloat(a.from)||i,s=parseFloat(a.to)||t,d=(s-r)/l*100,c=jl(a.color)||"gray",_="false"!==e.showabovelabels,b="false"!==e.showbelowlabels,h=_&&o!==n.length-1?G`<div class="segment-label-above" style="color: ${c};">${ke(s,this.hass.locale)}${e.unit||""}</div>`:K,m=b&&a.label?G`<div class="segment-label-below" style="color: ${c};">${$l(`label_below.${a.label}`)||a.label||""}</div>`:K;return G`
    ...
    `;return o?G`<div class="bar-container">${_}</div>`:_}getIconUrl(e){var a,o;return`${null!==(o=null===(a=this.config)||void 0===a?void 0:a.icons_body)&&void 0!==o?o:"/local/images/bodyscoreIcon"}/${e}`}renderIcon(e,a="default"){var o,i,t;if(!this.hass||!(null===(o=this.config)||void 0===o?void 0:o.entity))return K;const l=this.hass.states[this.config.entity];if(!l)return K;const n="water"===e.key.toLowerCase()&&"water_icon"in l.attributes?l.attributes.water_icon:e.icon;if(!n)return K;const r=this.getIconUrl(e.icon);if("body"===a&&r)return G`
        <ha-icon
          class="image"
          style="
    ...
    `:K}renderToolbar(){var e;return this.config.show_toolbar?G`
      <div class="toolbar" @ll-custom=${this.customEvent} ?open=${this.open}>
        <ha-icon-button
          @click=${this.toggle}
          title=${he($l("common.toggle_power")||void 0)}
    ...
    `:K}renderDropdown(e,a){var o,i;if(!this.hass||!(null===(o=this.config)||void 0===o?void 0:o.entity))return K;const t=this.hass.states[this.config.entity];if(!(null==t?void 0:t.attributes))return K;const l=null!==(i=t.attributes[`${a}_list`])&&void 0!==i?i:[];return Array.isArray(l)&&0!==l.length?G` <div
    ...
    </div>`:K}render(){var e,a,o,i;if(!this.hass||!(null===(e=this.config)||void 0===e?void 0:e.entity))return K;const t=this.hass.states[this.config.entity];if(!t)return G`
        <ha-card>
          <div class="preview not-available">
            <div class="metadata">
              <div class="not-available">
                ${$l("common.not_available")}
              </div>
            </div>
          </div>
        </ha-card>
...
`;xl(Rl);let Wl=class extends ne{constructor(){super(...arguments),this.page=1,this.selectedColor="white",this.config={},this.isInitialized=!1}setConfig(e){this.config=Object.assign({},e)}async connectedCallback(){super.connectedCallback(),await this.loadCardHelpers()}shouldUpdate(){return this.isInitialized||this.initialize(),!0}render(){if(!this.hass||!this.helpers)return K;const e=Object.assign(Object.assign({},El),this.config);return G`
    ...
    `}_handleConfigClick(){this.page=1}_handleCustomClick(){this.page=2}renderPage1(e){const a=Object.keys(this.hass.states).filter(e=>e.startsWith("bodymiscale."));return G`
      <div class="flex-space-between">
        <h2 class="page-title">${$l("editor.configuration")}</h2>
        <div class="navigation">
          <ha-icon-button
            @click=${this._handleConfigClick}
            .disabled=${1===this.page}
            .label="${$l("editor.configuration")}"
          >
      ...
      <strong>${$l("editor.code_only_note")}</strong>
    `}renderPage2(e){return G`
      <div class="flex-space-between">
        <h2 class="page-title">${$l("editor.customization")}</h2>
        <div class="navigation">
          <ha-icon-button
            @click=${this._handleConfigClick}
            .disabled=${1===this.page}
    ...
    `}renderSwitch(e,a,o=!1){return G`
      <div style="padding: ${o?"0 0 0 45px":"0"}">
        ...
        <div class="option">
          <ha-formfield
            .label=${$l(a[e]?`editor.${e}_aria_label_off`:`editor.${e}_aria_label_on`)}
          >
            <ha-switch
              .checked=${Boolean(a[e])}
              .configValue=${e}
    ...
    `}renderBodyOptions(e){var a;const o=!1===e.unit?Ol:Tl,i=null!==(a=e.body)&&void 0!==a?a:{};return Object.keys(o).filter(a=>{const i=o[a];return!1!==e.model||!i.impedance_required}).map(e=>{var a,t,l,n,r,s;const d=o[e],c=(null===(a=i[e])||void 0===a?void 0:a.positions)||d.positions||{},_=void 0!==(null===(t=i[e])||void 0===t?void 0:t.showabovelabels)&&null!==(null===(l=i[e])||void 0===l?void 0:l.showabovelabels)?i[e].showabovelabels:d.showabovelabels,b=void 0!==(null===(n=i[e])||void 0===n?void 0:n.showbelowlabels)&&null!==(null===(r=i[e])||void 0===r?void 0:r.showbelowlabels)?i[e].showbelowlabels:d.showbelowlabels,h=(null===(s=i[e])||void 0===s?void 0:s.severity)||d.severity,m=$l(`body.${e}`);return G`
      ...
      <div class="option">
        <ha-select
          .label=${$l(`editor_body.${e}_position`)}
          ...
          class="full"
        >
          ${void 0===a?G`<mwc-list-item value="" selected disabled></mwc-list-item>`:K}
          <mwc-list-item value="left"
            >${$l("editor_body.left")}</mwc-list-item
          >
          <mwc-list-item value="right"
            >${$l("editor_body.right")}</mwc-list-item
          >
          <mwc-list-item value="off"
            >${$l("editor_body.off")}</mwc-list-item
          >
        </ha-select>
      </div>
    `}renderBooleanSelector(e,a,o){if(null==a)return K;const i=String(a);return G`
      <div class="option">
        <ha-select
          ...
          class="full"
        >
          <mwc-list-item value="true">${$l("editor_body.on")}</mwc-list-item>
          <mwc-list-item value="false">${$l("editor_body.off")}</mwc-list-item>
        </ha-select>
      </div>
        ...
        ${i.map((e,o)=>{var i,t,l,n;return G`
              <div class="severity-row">
                ...
                <div class="below-line">
                  <ha-textfield
                    .label=${$l("editor_body.label_below")}
